...
const features = [
  ...
  { icon: "⚡", title: "Temps réel absolu", desc: "Chaque commande frappe l'écran cuisine à la vitesse de la lumière. Le client voit son statut évoluer en direct : en cours, prêt, servi. Pas de délai. Pas de 'peut-être'.", highlight: false },
  { icon: "⏱️", title: "Temps d'attente estimé", desc: "Chaque plat affiche son délai de préparation. Le client voit un compte à rebours en direct. Si ça dépasse, un message d'excuse est envoyé et la cuisine est alertée — automatiquement.", highlight: false },
  ...
  { icon: "👤", title: "Portail Serveur : Dashboard individuel", desc: "Chaque serveur a son propre espace sécurisé par PIN. Il voit ses tables, ses commandes, ferme les sessions et gère les paiements fractionnés. Zéro confusion, efficacité totale.", highlight: false },
  ...
  { icon: "📊", title: "Analytics sans pitié", desc: "CA, ticket moyen, pourboires, paiements fractionnés. Vous voyez tout. Vous dirigez avec des données, pas des intuitions.", highlight: false },
...
const plans = [
  {
    ...
    features: [
      "Jusqu'à 30 tables",
      "Menu illimité + temps d'attente par plat",
      "Commandes QR temps réel",
      "Suivi commande en direct (client)",
      "Paiement fractionné (égal / personnalisé)",
      "Flux addition complet (client→serveur→caisse)",
  ...
  },
  {
    ...
    features: [
      "Tables illimitées",
      "Multi-utilisateurs",
      "Analytics avancées (CA, tips, splits)",
      "Pourboires digitaux",
      "Avis vérifiés",
      "Portail serveur complet",
      "Fermeture session par serveur",
      "Défis serveurs quotidiens",
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="space-y-6">
            {[
              ...
              { n: "05", title: "Addition sans friction", desc: "Client demande l'addition → serveur confirme → caisse encaisse. Chacun paie sa part (égale ou libre), par carte ou espèces. La table se ferme toute seule. Aucune confusion.", color: "from-emerald-500/20 to-green-500/10", tags: ["Paiement fractionné", "Flux temps réel", "Auto-fermeture"] },
            ].map((step, i) => (
