    ...
    "@graph": [
      ...
      },
      {
        ...
        offers: [
          {
            "@type": "Offer",
            name: "Module Avis Google & Réputation",
            description: "Campagne QR avis, IA rédactionnelle, bons de réduction automatiques.",
            price: "79",
            priceCurrency: "EUR",
          ...
          {
            "@type": "Offer",
            name: "Module Commande & Paiement QR",
            description: "Menu digital QR, paiement fractionné, tickets.",
            price: "99",
            priceCurrency: "EUR",
            priceValidUntil: "2027-01-01",
            availability: "https://schema.org/InStock",
          ...
          {
            "@type": "Offer",
            name: "Module Portail Serveur Live",
            description: "Portail serveur, cuisine, caisse — gestion tables et commandes temps réel.",
            price: "69",
            priceCurrency: "EUR",
            priceValidUntil: "2027-01-01",
            availability: "https://schema.org/InStock",
          ...
          {
            "@type": "Offer",
            name: "Module Réservations Intelligentes",
            description: "Créneaux dynamiques, arrhes Stripe, anti no-show.",
            price: "129",
            priceCurrency: "EUR",
            priceValidUntil: "2027-01-01",
            availability: "https://schema.org/InStock",
          ...
          {
            "@type": "Offer",
            name: "Module Nova Stock IA",
            description: "Listes de courses auto, alertes ruptures, food cost.",
            price: "89",
            priceCurrency: "EUR",
            priceValidUntil: "2027-01-01",
            availability: "https://schema.org/InStock",
          ...
          {
            "@type": "Offer",
            name: "Module Nova Finance IA",
            description: "Food cost réel, KPIs, marges, prévisions CA.",
            price: "69",
            priceCurrency: "EUR",
            priceValidUntil: "2027-01-01",
            availability: "https://schema.org/InStock",
          ...
          {
            "@type": "Offer",
            name: "Module Nova Contab IA",
            description: "Exports comptables, TVA, rapports fin de mois intelligents.",
            price: "69",
            priceCurrency: "EUR",
            priceValidUntil: "2027-01-01",
            availability: "https://schema.org/InStock",
