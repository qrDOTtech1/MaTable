...
export default function Page() {
  const faq = {
    ...
    mainEntity: [
      ...
      { "@type": "Question", name: "Combien coûte un logiciel de gestion restaurant ?", acceptedAnswer: { "@type": "Answer", text: "MaTable Pro propose 3 forfaits : Starter à 59€ HT/mois, Pro à 119€ HT/mois avec programme fidélité inclus, et Business à 249€ HT/mois. Mensuel sans engagement ou annuel avec -12%. Essai gratuit sans carte bancaire sur matable.pro." } },
